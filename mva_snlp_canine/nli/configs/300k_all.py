...
TRAIN_LANGUAGES_SUBSET = ["en", "fr", "es", "bg", "ru"]
TRAIN_PROBS = [
    1 / len(TRAIN_LANGUAGES_SUBSET) for _ in range(len(TRAIN_LANGUAGES_SUBSET))
]

TEST_LANGUAGES_SUBSET = ["en", "fr", "es", "bg", "ru"]
TEST_PROBS = [1 / len(TEST_LANGUAGES_SUBSET) for _ in range(len(TEST_LANGUAGES_SUBSET))]
