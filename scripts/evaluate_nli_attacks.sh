...
nli_visualize_results 100k_en --attacked
echo "========================"
...
nli_visualize_results 300k_all --attacked
echo "========================"
...
nli_visualize_results 200k_ar_tr --attacked
echo "========================"
...
nli_visualize_results 100k_zh_th --attacked
echo "========================"
...
echo "------------------------"
nli_augmented_dataset 300k_all --language_subset 'en,fr,es,bg,ru,de,el'
nli_visualize_results 300k_all --languages 'en, fr, es, bg, ru' --attacked
echo "========================"
